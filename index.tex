...
distribution with a prior mean of 0.405, or \(\logit(70)\), with
\(\sigma=.25\) to allow for some uncertainty. This rate is close to the
empirical FLPR mean of 70\% across counties. Childcare burden is modeled
with a weakly informative prior of \(\mu=0, \sigma=0.15\), assuming no
direction of relationship, but expecting few extreme values.
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/heterogeneity_plot.png}}
...
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Greedy occupation context
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
Mean change in FLPR (pp)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
SD
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
