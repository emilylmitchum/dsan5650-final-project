...
County-level FLPR resembles a normal distribution, therefore, FLPR is modeled using a normal likelihood. The intercept term, or baseline female labor force participation rate, is drawn from a normal distribution with a prior mean of 0.405, or $\logit(70)$, with $\sigma=.25$ to allow for some uncertainty. This rate is close to the empirical FLPR mean of 70% across counties. Childcare burden is modeled with a weakly informative prior of $\mu=0, \sigma=0.15$, assuming no direction of relationship, but expecting few extreme values.
...
|:---|---:|---:|---:|---:|
| Intercept | 1.172 [1.10, 1.20] | 1.167 [1.10, 1.20] | 1.167 [1.10, 1.20] | 1.168 [1.10, 1.20] |
| Childcare burden | -0.107 [-0.160, -0.058] | -0.120 [-0.170, -0.070] | -0.122 [-0.170, -0.076] | -0.103 [-0.150, -0.052] |
| Greedy occupation share | — | 0.112 [0.064, 0.160] | 0.067 [0.010, 0.130] | 0.085 [0.026, 0.140] |
| Childcare burden × greedy share | — | 0.072 [0.026, 0.120] | 0.069 [0.022, 0.120] | 0.070 [0.023, 0.110] |
| Bachelor's-plus attainment | — | — | 0.084 [0.024, 0.140] | 0.155 [0.092, 0.220] |
| Born-in-state share | — | — | — | 0.173 [0.120, 0.230] |
